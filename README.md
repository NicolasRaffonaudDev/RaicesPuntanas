...
- Resiliencia en im·genes locales: si un lote referencia /uploads/... pero el archivo no existe en runtime (404), el backend ahora devuelve un placeholder para evitar imagen rota en UI.
